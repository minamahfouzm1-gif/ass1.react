            ...
            <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
              <div className="text-center max-w-4xl mx-auto">
                ...
                <div className="flex flex-col sm:flex-row justify-center gap-4 mb-16">
                  <Link
                    className="btn-primary inline-flex items-center justify-center gap-2 group bg-orange-600 rounded-3xl p-4 text-amber-50"
                    to="/about"
                    data-discover="true"
                  >
                  ...
                  <Link
                    className="btn-secondary inline-flex items-center justify-center gap-2 rounded-3xl p-4 text-amber-50 border border-transparent-50"
                    to="/content"
                    data-discover="true"
                  >
                    <svg
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-3xl mx-auto">
                  ...
                  >
                    ...
                    <p className="text-2xl md:text-3xl font-bold gradient-text text-orange-300">
                      +50
                    </p>
